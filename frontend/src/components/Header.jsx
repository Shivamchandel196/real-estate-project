  ...
  return (
    ...
    >
      <div className="flex justify-between items-center max-w-7xl mx-auto px-6 h-[68px]">
        ...
        <form
          ...
          className="hidden md:flex items-center bg-[#1a1d24] border border-white/[0.07]
            ...
            px-4 py-[6px] rounded-full w-[38%] transition-all duration-300"
        >
          <input
            type="text"
          ...
          <button
            type="submit"
            className="bg-yellow-500 hover:bg-yellow-400 transition-all duration-200
              text-[#0b0c0e] w-8 h-8 rounded-full flex items-center justify-center
              flex-shrink-0 ml-2 hover:scale-110 text-xs"
          >
            <FaSearch />
          </button>
        </form>
        ...
        <ul className="flex items-center gap-1">
          {[
            ...
            <Link to={to} key={to}>
              <li
                className={`hidden sm:inline-block px-3 py-2 rounded-md text-sm font-medium
              ...
              {currentUser ? (
                <div className="relative group">
                  ...
                  <div className="absolute hidden group-hover:block right-0 top-[calc(100%+10px)]
                    ...
                    <div className="absolute -top-[6px] right-4 w-3 h-3 bg-[#1a1d24]
                      border-l border-t border-yellow-900/30 rotate-45" />
                ...
                <button
                  className="border border-yellow-500/50 text-yellow-500 hover:bg-yellow-500
                    hover:text-[#0b0c0e] hover:border-yellow-500
                    hover:shadow-[0_4px_20px_rgba(201,168,76,0.3)]
                    transition-all duration-200 px-5 py-2 rounded text-sm font-semibold
      ...
      <div className="md:hidden px-4 pb-3 border-t border-white/[0.04]">
        <form
          onSubmit={handleSubmit}
          className="flex items-center bg-[#1a1d24] border border-white/[0.07]
            focus-within:border-yellow-500/40 rounded-full px-4 py-2 mt-3
            transition-all duration-300"
        >
          <input
            type="text"
            ...
            onChange={(e) => setSearchTerm(e.target.value)}
          />
          <button type="submit" className="text-yellow-500 ml-2 text-sm">
            <FaSearch />
          </button>
        </form>
      </div>

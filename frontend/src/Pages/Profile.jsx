...
const Profile = () => {
  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
     ...
     <img onClick={handleTrigger} src={currentUser.avatar} alt="avatar" className='rounded-full h-24 w-24 object-cover cursor-pointer self-center mt-2' />
    ...
    <button className='bg-slate-700 text-white p-3 rounded-lg uppercase text-center hover:opacity-95'>
     ...
     <div className='flex justify-between mt-4'>
      ...
      <span className='text-red-700 cursor-pointer'>Account Delete</span>
